                ...
                <div className="timeline-centered">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2><a href="#">Business Analyst at Plentix</a> <span>2018</span></h2>
                        <p>{plentixText}</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2><a href="#">Campaigns Advisor at Oaktree</a> <span>2018</span></h2>
                        <p>{oaktreeText}</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2><a href="#">Bachelor of Science at the University of Melbourne, Majoring in Mechatronics</a> <span>2016-present</span></h2>
                        <p>{universityText}</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2><a href="#">ACG Parnell College</a> <span>2008-2015</span></h2>
                        <p>{parnellText}</p> 
                      </div>
                    </div>
                  </article>
